...
getVersion() {
    ...
    TAG_URL="https://api.github.com/repos/xxf185/sb-core/releases/latest"
...
installSingBox() {
	...
	DOWNLOAD_LINK="https://github.com/xxf185/sb-core/releases/download/${NEW_VER_V}/sing-box-${NEW_VER}-linux-${ARCH}.tar.gz"
